 ...
 /**
  ...
  listen(port, token) {
    ...
    dispatcher.onGet("/", function(req, res) {
      res.writeHead(200, {'Content-Type': 'text/html'});
      let html = '<h1>Spark Bot</h1><p>This is a bot for choosing a random person in a specific channel</p><a id="add-to-slack" href="'+add_to_slack+'"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a><script src="https://button.glitch.me/button.js" data-style="glitch"></script><div class="glitchButton" style="position:fixed;top:20px;right:20px;"></div>';
      res.end(html);
    });     
  ...
  post(endPoint, payload) {
    ...
    if (!/^http/i.test(endPoint)) {
      ...
      if(payload.attachments && isJSON(payload.attachments)){
